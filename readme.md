...
* **CodeF:** Not actively used in the final code, but it was my major source of inspiration for the graphic processing in javascript.
* **Webaudio Mod Player:** Used to play the music, with slight modifications to support custom speed adjustments. 
